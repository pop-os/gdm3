...
static const GDBusArgInfo * const _gdm_dbus_manager_method_info_register_display_IN_ARG_pointers[] =
{
  &_gdm_dbus_manager_method_info_register_display_IN_ARG_details.parent_struct,
  NULL
};
...
static const _ExtendedGDBusArgInfo _gdm_dbus_manager_method_info_register_session_IN_ARG_details =
{
  {
    -1,
    (gchar *) "details",
...
static const GDBusArgInfo * const _gdm_dbus_manager_method_info_register_session_IN_ARG_pointers[] =
{
  &_gdm_dbus_manager_method_info_register_session_IN_ARG_details.parent_struct,
  NULL
};

static const _ExtendedGDBusMethodInfo _gdm_dbus_manager_method_info_register_session =
{
  {
    -1,
    (gchar *) "RegisterSession",
    (GDBusArgInfo **) &_gdm_dbus_manager_method_info_register_session_IN_ARG_pointers,
    NULL,
    NULL
  },
...
static const GDBusArgInfo * const _gdm_dbus_manager_method_info_open_session_OUT_ARG_pointers[] =
{
  &_gdm_dbus_manager_method_info_open_session_OUT_ARG_address.parent_struct,
  NULL
};
...
static const GDBusArgInfo * const _gdm_dbus_manager_method_info_open_reauthentication_channel_IN_ARG_pointers[] =
{
  &_gdm_dbus_manager_method_info_open_reauthentication_channel_IN_ARG_username.parent_struct,
  NULL
};
...
static const GDBusArgInfo * const _gdm_dbus_manager_method_info_open_reauthentication_channel_OUT_ARG_pointers[] =
{
  &_gdm_dbus_manager_method_info_open_reauthentication_channel_OUT_ARG_address.parent_struct,
  NULL
};
...
static const GDBusMethodInfo * const _gdm_dbus_manager_method_info_pointers[] =
{
  &_gdm_dbus_manager_method_info_register_display.parent_struct,
  &_gdm_dbus_manager_method_info_register_session.parent_struct,
  &_gdm_dbus_manager_method_info_open_session.parent_struct,
  &_gdm_dbus_manager_method_info_open_reauthentication_channel.parent_struct,
  NULL
};
...
static const GDBusPropertyInfo * const _gdm_dbus_manager_property_info_pointers[] =
{
  &_gdm_dbus_manager_property_info_version.parent_struct,
  NULL
};
 ...
 * @handle_register_session: Handler for the #GdmDBusManager::handle-register-session signal.
...
gdm_dbus_manager_default_init (GdmDBusManagerIface *iface)
{
  ...
  /**
   * GdmDBusManager::handle-register-session:
   * @object: A #GdmDBusManager.
   * @invocation: A #GDBusMethodInvocation.
   * @arg_details: Argument passed by remote caller.
   *
   ...
   *
   * If a signal handler returns %TRUE, it means the signal handler will handle the invocation (e.g. take a reference to @invocation and eventually call gdm_dbus_manager_complete_register_session() or e.g. g_dbus_method_invocation_return_error() on it) and no order signal handlers will run. If no signal handler handles the invocation, the %G_DBUS_ERROR_UNKNOWN_METHOD error is returned.
   *
   * Returns: %TRUE if the invocation was handled, %FALSE to let other signal handlers run.
   */
  g_signal_new ("handle-register-session",
    G_TYPE_FROM_INTERFACE (iface),
    G_SIGNAL_RUN_LAST,
    G_STRUCT_OFFSET (GdmDBusManagerIface, handle_register_session),
    g_signal_accumulator_true_handled,
    NULL,
    g_cclosure_marshal_generic,
    G_TYPE_BOOLEAN,
 ...
 *
 * The returned value is only valid until the property changes so on the client-side it is only safe to use this function on the thread where @object was constructed. Use gdm_dbus_manager_dup_version() if on another thread.
 *
...
/**
 * gdm_dbus_manager_call_register_session:
 * @proxy: A #GdmDBusManagerProxy.
 * @arg_details: Argument to pass with the method invocation.
 * @cancellable: (nullable): A #GCancellable or %NULL.
 * @callback: A #GAsyncReadyCallback to call when the request is satisfied or %NULL.
 ...
 * When the operation is finished, @callback will be invoked in the thread-default main loop of the thread you are calling this method from (see g_main_context_push_thread_default()).
 * You can then call gdm_dbus_manager_call_register_session_finish() to get the result of the operation.
 *
 * See gdm_dbus_manager_call_register_session_sync() for the synchronous, blocking version of this method.
 */
void
gdm_dbus_manager_call_register_session (
    GdmDBusManager *proxy,
...
/**
 * gdm_dbus_manager_call_register_session_finish:
 * @proxy: A #GdmDBusManagerProxy.
 * @res: The #GAsyncResult obtained from the #GAsyncReadyCallback passed to gdm_dbus_manager_call_register_session().
 * @error: Return location for error or %NULL.
 *
 * Finishes an operation started with gdm_dbus_manager_call_register_session().
 *
 * Returns: (skip): %TRUE if the call succeded, %FALSE if @error is set.
 */
gboolean
...
/**
 * gdm_dbus_manager_call_register_session_sync:
 * @proxy: A #GdmDBusManagerProxy.
 * @arg_details: Argument to pass with the method invocation.
 * @cancellable: (nullable): A #GCancellable or %NULL.
 * @error: Return location for error or %NULL.
 ...
 *
 * See gdm_dbus_manager_call_register_session() for the asynchronous version of this method.
 *
 * Returns: (skip): %TRUE if the call succeded, %FALSE if @error is set.
 */
gboolean
...
/**
 * gdm_dbus_manager_complete_register_session:
 * @object: A #GdmDBusManager.
 * @invocation: (transfer full): A #GDBusMethodInvocation.
 *
  ...
  GParamSpec   *pspec G_GNUC_UNUSED)
{
  ...
  info = (const _ExtendedGDBusPropertyInfo *) _gdm_dbus_manager_property_info_pointers[prop_id - 1];
  ...
  if (!_g_value_equal (value, &skeleton->priv->properties[prop_id - 1]))
    {
      if (g_dbus_interface_skeleton_get_connection (G_DBUS_INTERFACE_SKELETON (skeleton)) != NULL &&
        ...
        _gdm_dbus_manager_schedule_emit_changed (skeleton, info, prop_id, &skeleton->priv->properties[prop_id - 1]);
