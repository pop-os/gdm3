...
struct _GdmDBusManagerIface
{
  ...
  gboolean (*handle_register_session) (
    GdmDBusManager *object,
    GDBusMethodInvocation *invocation,
    GVariant *arg_details);
...
void gdm_dbus_manager_complete_register_session (
    GdmDBusManager *object,
    GDBusMethodInvocation *invocation);
...
void gdm_dbus_manager_call_register_session (
    GdmDBusManager *proxy,
    GVariant *arg_details,
    GCancellable *cancellable,
    GAsyncReadyCallback callback,
...
gboolean gdm_dbus_manager_call_register_session_finish (
    GdmDBusManager *proxy,
    GAsyncResult *res,
    GError **error);

gboolean gdm_dbus_manager_call_register_session_sync (
    GdmDBusManager *proxy,
    GVariant *arg_details,
    GCancellable *cancellable,
    GError **error);
